...
if __name__ == "__main__":
	tickers = ['SPY', 'QQQ', 'EWJ', 'ASHR', 'DBC', 'LQD', 'EMB', 'TLT', 'IEF', 'GLD']
	print get_implied_volatilities_for_tickers(tickers)
	print get_implied_volatilities_for_tickers(tickers, get_variance = False)